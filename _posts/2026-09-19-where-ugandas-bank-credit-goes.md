---
layout: post
title: "Where Uganda's Bank Credit Goes"
...
Here is where the numbers, for all their usefulness, go quiet — and where the quiet matters most for policy. This dataset is national and sectoral. It has no column for gender and no column for region. So the aggregate that tells us so much also leaves two things unaccounted for.

It cannot see women. Women's economic activity concentrates in smallholder farming and informal retail — the under-credited corners of this map. The ledger does not report that women receive less credit; it reports nothing about women at all. That silence is not an oversight. It is the shape of the instrument.

And it cannot see the North. There is no Lango in a national total, no Acholi, no distinct picture of any region. A single figure, weighted toward the centre of the economy, is reported as "Uganda." What a dataset chooses to count is itself a claim about who counts.

This is the same argument we make about language and voice — that data collected in English, from people already online, quietly decides whose knowledge is treated as real. Here it is written in shillings. The most instructive feature of Uganda's credit ledger is not only the story it tells about consumption, property and oil. It is the story it is not built to tell: a credit system that could be disaggregated by sex and by region, and reported that way, would let local government and lenders see gaps they currently cannot. Until it is, the aggregate will keep answering "how much?" while leaving "for whom?" unanswered.

<b>About the data</b>

Figures are drawn from the Bank of Uganda's Outstanding Credit by Sector series for deposit-taking institutions (all currencies), monthly, covering the period to July 2026. Percentages are shares of total outstanding credit; growth figures compare July 2025 with July 2026 and are nominal. Sector totals aggregate the published sub-sectors. If you work on economic data, financial inclusion or regional policy and would like the workings behind these charts, or want to challenge how we have grouped the sectors, contact us via team (at) amarahub (dot) org.
