...
In each quarter, five ordered rules assigned to every panel household to one type, using monitoring data we already collect, with no new survey having to be collected.
